...
class InstaBot:
    ...
    def login(self):
        ...
        time.sleep(5)
        self.driver.find_element_by_xpath('/html/body/div[1]/section/main/div/div/div[1]/div/form/div/div[3]/button/div').click()
        time.sleep(3)
...
if __name__=='__main__':
    ig_bot = InstaBot('hokages_point','kakashihatake821') #add your username and password
